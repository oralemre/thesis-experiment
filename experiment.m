...
%[time1,time2,point1x,point1y,point2x,point2y] = ...
%                draw_screen(window, Wcenter,Hcenter,3,[],char(ts{1,1}),test1,test2,text_w2,text_w3,text_w4,text_w5)    
         
%[time1,time2,point1x,point1y,point2x,point2y] = ...
%                draw_screen(window, Wcenter,Hcenter,3,[],trdf{1,1},'','',text_w2,text_w3,text_w4,text_w5)
